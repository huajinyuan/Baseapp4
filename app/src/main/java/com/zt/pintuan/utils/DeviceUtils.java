...
public class DeviceUtils {
    ...
    private static String getMacAddressByWifiInfo() {
        try {
            WifiManager wifi = (WifiManager) AppContext.getContext().getApplicationContext().getSystemService(Context.WIFI_SERVICE);
            if (wifi != null) {
    ...
    public static void reboot(String reason) {
        PowerManager mPowerManager = (PowerManager) AppContext.getContext().getSystemService(Context.POWER_SERVICE);
        try {
