    ...
    public static String getForegroundProcessName() {
        ...
        if (android.os.Build.VERSION.SDK_INT > android.os.Build.VERSION_CODES.LOLLIPOP) {
            ...
            if (list.size() > 0) {// 有"有权查看使用权限的应用"选项
                try {
                    ApplicationInfo info = packageManager.getApplicationInfo(AppContext.getContext().getPackageName(), 0);
                    AppOpsManager aom = (AppOpsManager) AppContext.getContext().getSystemService(Context.APP_OPS_SERVICE);
