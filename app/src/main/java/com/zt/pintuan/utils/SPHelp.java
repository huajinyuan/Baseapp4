...
public class SPHelp {
    ...
    public static void removeAppParam(String key){
        removeAppParam(AppContext.getContext(), key);
    }

    public static void removeAppParam(Context context, String key){
        removeParam(context, false, key);
    }

    public static void removeUserParam(String key){
        removeUserParam(AppContext.getContext(), key);
    }

    public static void removeUserParam(Context context, String key){
        removeParam(context, true, key);
    }
    ...
    /**根据key移除数据*/
    private static void removeParam(Context context, boolean isUserParams, String key){
        SharedPreferences.Editor editor = getPref(context, isUserParams ? SP_FILE.USER : SP_FILE.APP).edit();
        editor.remove(key);
        editor.commit();
    }
