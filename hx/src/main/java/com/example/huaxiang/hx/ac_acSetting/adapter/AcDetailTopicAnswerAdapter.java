 ...
 */
public class AcDetailTopicAnswerAdapter extends RecyclerView.Adapter<AcDetailTopicAnswerAdapter.AnchorHotViewHolder> {
    ...
    public AcDetailTopicAnswerAdapter(Context mContext, HxTopic mData) {
        data = mData;
        context = mContext;
