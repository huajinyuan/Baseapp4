package com.example.zhongchou.module.dialog;
...
public class CustomPopWindow {
    ...
    private PopupWindow build() {
        ...
        if (mWidth != 0 && mHeight != 0) {
            ...
            int width = isFullWidth ? ViewGroup.LayoutParams.MATCH_PARENT : ViewGroup.LayoutParams.WRAP_CONTENT;
            int height = isFullHeight ? ViewGroup.LayoutParams.MATCH_PARENT : ViewGroup.LayoutParams.WRAP_CONTENT;
    ...
    public static class PopupWindowBuilder {
        ...
        public PopupWindowBuilder setFullWidth(boolean isFullWidth) {
            mCustomPopWindow.isFullWidth = isFullWidth;
            return this;
        }

        public PopupWindowBuilder setFullHeight(boolean isFullHeight) {
            mCustomPopWindow.isFullHeight = isFullHeight;
            return this;
        }
        ...
        public PopupWindowBuilder setView(View view, boolean fullWidth, boolean fullHeight) {
        ...
        public PopupWindowBuilder setColorDrawable(ColorDrawable colorDrawable) {
            mCustomPopWindow.mColorDrawable = colorDrawable;
            return this;
        }
