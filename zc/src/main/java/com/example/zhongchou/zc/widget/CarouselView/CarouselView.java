package com.example.zhongchou.zc.widget.CarouselView;
...
public class CarouselView extends FrameLayout implements ViewPager.OnPageChangeListener {
    ...
    public void setNews(ArrayList<String> datas) {
        this.mDatas = datas;
    }
    ...
    public void onPageSelected(int position) {
        ...
        if (position < mDatas.size()) {
            this.tvTip.setText(mDatas.get(position));
        }
        for (int i = 0; i < count; i++) {
    ...
    class ViewPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            if (position < mDatas.size()) {
                tvTip.setText(mDatas.get(position));
            }
            return view;
        }
